...
const DokumenPengabdianPadaMasyarakat = () => {
  ...
  useEffect(() => {
    const fetchAndGroupData = async () => {
      ...
      setError("");
      try {
        const response = await fetch(`${api}/dokumenpengab/`);
        if (!response.ok) {
  ...
  return (
    <div className="dokumen-page">
      <Herosection title={"Dokumen Pengabdian Kepada Masyarakat"} />

      <div className="dokumen-content py-5">
        <Container>
          <Row className="mb-5">
            <Col className="text-center">
              <h1 className="fw-bold">Dokumen Pengabdian Kepada Masyarakat</h1>
...
export default DokumenPengabdianPadaMasyarakat;
