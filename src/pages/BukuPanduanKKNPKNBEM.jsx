...
const BukuPanduanKKNPKNBEM = () => {
  ...
  return (
    <div className="panduan-page">
      <Herosection title={"Buku Panduan KKN PKN BEM UNIM"} />

      <div className="timeline-wrapper py-5">
        <Container>
          <Row className="text-center mb-5">
            <Col>
              <h1 className="fw-bold">Buku Panduan KKN PKN BEM UNIM</h1>
              <p className="text-muted">
                Kumpulan dokumen Buku Panduan KKN PKN BEM UNIM
              </p>
            </Col>
          </Row>
          <Row>
...
export default BukuPanduanKKNPKNBEM;
