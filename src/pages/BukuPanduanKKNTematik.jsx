...
const BukuPanduanKKNTematik = () => {
  ...
  return (
    <div className="panduan-page">
      <Herosection title={"Buku Panduan KKN Tematik UNIM"} />

      <div className="timeline-wrapper py-5">
        <Container>
          <Row className="text-center mb-5">
            <Col>
              <h1 className="fw-bold">Buku Panduan KKN Tematik UNIM</h1>
              <p className="text-muted">
                Kumpulan dokumen Buku Panduan KKN Tematik UNIM
              </p>
            </Col>
          </Row>
          <Row>
...
export default BukuPanduanKKNTematik;
