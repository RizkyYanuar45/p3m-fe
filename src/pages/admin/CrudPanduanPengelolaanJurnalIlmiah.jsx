...
const CrudPanduanPengelolaanJurnalIlmiah = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editId) {
      ...
      const dataToSend = {
        ...form,
        file_type: "panduan_pengelolaan_jurnal_ilmiah",
      };
      try {
  ...
  return (
    <div>
      <h3>Panduan Pengelolaan Jurnal Ilmiah</h3>
...
export default CrudPanduanPengelolaanJurnalIlmiah;
