...
const CrudSKKKNTematik = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(
          `${api}/files/type?type=sk_rektor_pelaksanaan_kkn_tematik`
        );
        if (!response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editId) {
      ...
      const dataToSend = {
        ...form,
        file_type: "sk_rektor_pelaksanaan_kkn_tematik",
      };
      try {
...
export default CrudSKKKNTematik;
