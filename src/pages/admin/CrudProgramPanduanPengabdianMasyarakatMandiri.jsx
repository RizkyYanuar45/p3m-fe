...
const CrudProgramPanduanPengabdianMasyarakatMandiri = () => {
          ...
          {data.map((item, idx) => (
            <tr key={item.id}>
              ...
              <td>
                ...
                <button onClick={() => setData(data.filter((_, i) => i !== idx))}>Hapus</button>
              </td>
            </tr>
          ))}
        </tbody>
...
export default CrudProgramPanduanPengabdianMasyarakatMandiri;
